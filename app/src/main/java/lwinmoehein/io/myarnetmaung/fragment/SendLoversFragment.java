...
public class SendLoversFragment  extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return  inflater.inflate(R.layout.fragment_sending_lovers, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        References.sentLovers.child(CurrentUser.currentUser.getUid()).addChildEventListener(new ChildEventListener() {
            @Override
